...
const referred = {
    FinancialWorksheet: {desc: '现金流表底稿', location: 'local'},
...
function importProc({FinancialWorksheet, BALANCE, CategoricalAccruals}){

    let [dateSec, contentSec] = FinancialWorksheet.tables,
